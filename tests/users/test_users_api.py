...
class TestUsersApi(unittest.TestCase):
    ...
    def test_list(self):
        ...
        self.assertIn({"id": 1, "name": "Fred Derf","email":"fred@gmail.com","is_admin":True}, response.json)

    def test_find(self):
        response = self.client.get("/users/2")

        self.assertEqual(200, response.status_code)
        self.assertEqual({"id": 2, "name": "Mary Yram","email":"mary@gmail.com","is_admin":False}, response.json)
